    ...
    <section className="section_alimentation">
      <div id="calories" className="margin">
        ...
        <div className="section_text">
          <p className="section_text-number">{(Score.calorieCount / 1000).toFixed(3)}kCal</p>
      ...
      <div id="protein" className="margin">
        ...
        <div className="section_text">
          <p className="section_text-number">{Score.proteinCount}g</p>
      ...
      <div id="carbohydrate" className="margin">
        ...
        <div className="section_text">
          <p className="section_text-number">{Score.carbohydrateCount}g</p>
      ...
      <div id="lipid" className="margin">
        ...
        <div className="section_text">
          <p className="section_text-number">{Score.lipidCount}g</p>
